...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home title">Ashutosh Tiwari
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Web Developer | Website Designer | Social Media Creative</h3>
        <p className="home__description">Welcome to my portfolio! I specialize in delivering innovative website solutions, captivating designs, and creative social media expertise.  </p>
